...
## Generated on : Sat Nov 28 02:01:49 2020
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Mouth/OneDrive/DOCUME~1/MCMAST~4/SWFREN~1/3K04-P~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
OBJS = MW_SCI.o MW_digitalIO.o mw_sdk_interface.o MW_AnalogInput.o MW_PWM.o i2c_api.o MW_I2C.o Pacemaker.o Pacemaker_data.o Send_DCM.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
Send_DCM.o : $(START_DIR)/Pacemaker_ert_rtw/Send_DCM.c
	$(CC) $(CFLAGS) -o "$@" "$<"
