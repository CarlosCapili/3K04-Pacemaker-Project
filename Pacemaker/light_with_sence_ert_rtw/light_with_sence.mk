###########################################################################
## Makefile generated for Simulink model 'light_with_sence'. 
## 
## Makefile     : light_with_sence.mk
## Generated on : Thu Oct 22 19:26:12 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/light_with_sence.elf
...
PRODUCT_NAME              = light_with_sence
MAKEFILE                  = light_with_sence.mk
MATLAB_ROOT               = D:/school
MATLAB_BIN                = D:/school/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Udeep/Downloads/3K04-Project-L1-G7-main/3K04-Project-L1-G7-main/Pacemaker
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = light_with_sence_comp.rsp
CMD_FILE                  = light_with_sence.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/light_with_sence.elf
...
DEFINES_STANDARD = -DMODEL=light_with_sence -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o light_with_sence.o light_with_sence_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/light_with_sence_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/light_with_sence_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/light_with_sence_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/light_with_sence_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/light_with_sence_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/light_with_sence_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


light_with_sence.o : $(START_DIR)/light_with_sence_ert_rtw/light_with_sence.c
	$(CC) $(CFLAGS) -o "$@" "$<"


light_with_sence_data.o : $(START_DIR)/light_with_sence_ert_rtw/light_with_sence_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
