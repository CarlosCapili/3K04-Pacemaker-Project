...
class ParametersHandler:
    ...
    def __init__(self, table: QTableWidget):
        ...
        self._object_per_param = {
            ...
            "Atrial Pulse Width": DoubleSpinBoxDelegate(0.1, 30, 0.1, "ms", parent=table),
            "Atrial Sensitivity": DoubleSpinBoxDelegate(0.5, 10, 0.5, "mV", parent=table),
            "Ventricular Amplitude": DoubleSpinBoxDelegate(0, 5, 0.1, "V", parent=table),
            "Ventricular Pulse Width": DoubleSpinBoxDelegate(0.1, 30, 0.1, "ms", parent=table),
            "Ventricular Sensitivity": DoubleSpinBoxDelegate(0.5, 10, 0.5, "mV", parent=table),
