...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.paceBox = QtWidgets.QCheckBox(self.centralwidget)
        self.paceBox.setChecked(True)
        self.paceBox.setAutoRepeat(False)
        self.paceBox.setTristate(False)
        self.paceBox.setObjectName("paceBox")
        self.horizontalLayout_2.addWidget(self.paceBox)
        self.senseBox = QtWidgets.QCheckBox(self.centralwidget)
        self.senseBox.setChecked(True)
        self.senseBox.setObjectName("senseBox")
        self.horizontalLayout_2.addWidget(self.senseBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.paceBox.setText(_translate("MainWindow", "Pace Leads"))
        self.senseBox.setText(_translate("MainWindow", "Sense Leads"))
