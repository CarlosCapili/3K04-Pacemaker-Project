...
The New Patient push button calls the \texttt{register\_device()} in the connection handler. The connection handler will generate a popup message depending on the results of the function.
