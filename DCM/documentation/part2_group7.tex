...
The real-time electrograms show real-time telemetry data from the pace and sense leads on the pacemaker. The graphs use the PlotWidget class from PyQtGraph, a QGraphicsWidget with additional functions for plotting. Checkboxes for pace/sense leads will show and hide the pace/sense plots. The expected behaviour of the checkboxes are shown in Table \ref{tab:DCM_MainWindow}.
