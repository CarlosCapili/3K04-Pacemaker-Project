...
\begin{tabular}{cc} \cmidrule{2-2}
    ...
    \multicolumn{1}{|c}{welcome\_ui.log\_btn} & \multicolumn{1}{|c|}{welcome\_gui.setCurrentIndex(2) \tikzmark{bottomright}}  \\ \cmidrule{1-2}
\end{tabular}
...
\begin{table}[ht]
    ...
    \begin{tabular}{ccc} \cmidrule{3-3}
        ...
        \multicolumn{1}{|c}{} & \multicolumn{1}{|c}{!isChecked()} & \multicolumn{1}{|c|}{graphs.sense\_hide() \tikzmark{bottomright}} \\ \cmidrule{1-3}
    \end{tabular}
...
\begin{table}[ht]
    ...
    \begin{tabular}{cc} \cmidrule{2-2}
        ...
        \multicolumn{1}{|c}{reports\_ui.temp\_btn} & \multicolumn{1}{|c|}{reports.generate\_temp(get\_pace\_mode\_params())\quad\tikzmark{bottomright}} \\ \cmidrule{1-2}
    \end{tabular}
