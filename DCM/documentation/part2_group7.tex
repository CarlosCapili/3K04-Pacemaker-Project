...
\subsubsection{Connection} MOSTLY COPY-PASTED PLS FIX \\
The connections handler handles STUFF.
The 6 public functions are the constructor, run, stop, \_update\_state, register\_device, and \_handle\_removed\_device.
...
\subsubsection{Parameters} MOSTLY COPY-PASTED PLS FIX \\
The parameters handler handles STUFF.
The 6 public functions are the constructor, confirm, reset, \_update\_params\_file, \_update\_params\_gui and filter\_params.
